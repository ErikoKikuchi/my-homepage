...
export default async function AboutPage() {
  ...
  const personJsonLd = {
    ...
    "@type": "Person",
    name: "BodyAndCode からだ散歩 エリコ",
    jobTitle: ["理学療法士", "ピラティスインストラクター", "エンジニア"],
    url: `${process.env.NEXT_PUBLIC_SITE_URL}/about`,
    sameAs: [
      "https://note.com/karada_sanpo",
      "https://note.com/body_and_code",
      "https://zenn.dev/karada_sanpo",
      "https://www.instagram.com/pilates.karada_sanpo/",
      "https://github.com/ErikoKikuchi",
    ],
  };
