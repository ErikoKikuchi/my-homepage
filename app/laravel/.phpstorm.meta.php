    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Laravel\Fortify\Contracts\LoginResponse' => \App\Actions\Fortify\LoginResponse::class,
    ...
    override(\config(), map([
            ...
            'database.connections.client_db.driver' => 'string',
            'database.connections.client_db.host' => 'string',
            'database.connections.client_db.port' => 'string',
            'database.connections.client_db.database' => 'string',
            'database.connections.client_db.username' => 'string',
            'database.connections.client_db.password' => 'string',
            'database.connections.client_db.unix_socket' => 'string',
            'database.connections.client_db.charset' => 'string',
            'database.connections.client_db.collation' => 'string',
            'database.connections.client_db.prefix' => 'string',
            'database.connections.client_db.prefix_indexes' => 'boolean',
            'database.connections.client_db.strict' => 'boolean',
            'database.connections.client_db.engine' => 'NULL',
            'database.connections.client_db.options' => 'array',
            ...
            'services.mailtrap.sandbox_url' => 'string',
...
'database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.client_db.driver','database.connections.client_db.host','database.connections.client_db.port',
'database.connections.client_db.database','database.connections.client_db.username','database.connections.client_db.password','database.connections.client_db.unix_socket','database.connections.client_db.charset',
'database.connections.client_db.collation','database.connections.client_db.prefix','database.connections.client_db.prefix_indexes','database.connections.client_db.strict','database.connections.client_db.engine',
'database.connections.client_db.options','database.migrations.table','database.migrations.update_date_on_publish','database.redis.client','database.redis.options.cluster',
...
'fortify.features','google2fa.enabled','google2fa.lifetime','google2fa.keep_alive','google2fa.auth',
'google2fa.guard','google2fa.session_var','google2fa.otp_input','google2fa.window','google2fa.forbid_old_passwords',
'google2fa.otp_secret_column','google2fa.view','google2fa.error_messages.wrong_otp','google2fa.error_messages.cannot_be_empty','google2fa.error_messages.unknown',
'google2fa.throw_exceptions','google2fa.qrcode_image_backend','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'services.ses.secret','services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.mailtrap.sandbox_url',
...
'signed','throttle','verified','admin.2fa',);
        registerArgumentsSet('routes', 
'login','login','logout','password.request','password.reset',
...
'two-factor.regenerate-recovery-codes','two-factor-verify',
'admin.two-factor','two-factor-setup','verification.open',
'admin.home','thinkmotion.guest.index','profile.register',
'thinkmotion.mypage','pilates.guest.index','pilates.guest.show','pilates.guest.create','pilates.mypage',
'pilates.user.reservation.cancel','pilates.user.reservation.index','pilates.user.reservation.store','pilates.user.reservation.show','pilates.user.training-log.index',
'pilates.user.training-log.create','pilates.user.training-log.store','pilates.user.training-log.show','pilates.user.training-log.edit','pilates.user.training-log.update',
'pilates.user.training-log.destroy','pilates.admin','pilates.admin.schedule','pilates.admin.reservation','pilates.admin.clients.archive',
'pilates.admin.client.index','pilates.admin.client.create','pilates.admin.client.store','pilates.admin.client.show','pilates.admin.client.edit',
'pilates.admin.client.update','pilates.admin.training-log.index','pilates.admin.training-log.create','pilates.admin.training-log.store','pilates.admin.training-log.show',
'pilates.admin.training-log.edit','pilates.admin.training-log.update','pilates.admin.training-log.destroy','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'auth.admin-login','auth.admin-two-factor-setup','auth.admin-two-factor-verify','auth.forgot-password','auth.register',
'auth.reset-password','auth.user-login','auth.verify-email','layouts.app','layouts.pilates',
'layouts.thinkmotion','pilates.guest.reservation','pilates.guest.reservation-detail','pilates.user.mypage','thinkmotion.admin.admin-dashboard',
'thinkmotion.guest.index','thinkmotion.top','thinkmotion.user.mypage','thinkmotion.user.profile-register','welcome',
...
'validation.custom.attribute-name.rule-name','actions.accept','actions.action','actions.actions','actions.add',
...
'http-statuses.598','http-statuses.599','http-statuses.unknownError','validation.attributes.address','validation.attributes.affiliate_url',
...
'DB_CLIENT_HOST','DB_CLIENT_PORT','DB_CLIENT_DATABASE','DB_CLIENT_USERNAME','DB_CLIENT_PASSWORD',
...
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','MAILTRAP_SANDBOX_URL','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY',
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','STATIC_URL',);
