...
@section ('content')
    <form
        class="max-w-md mx-auto bg-forest-dark text-paper p-8 rounded-sm shadow-sm"
        action="/thinkmotion/login"
        method="post"
    >
        @csrf
        <div class="p-5">
        ...
        <div class="flex justify-center m-6">
            <button
                class="btn bg-paper text-forest-dark hover:bg-[rgb(225,252,111)] cursor-pointer"
                type="submit"
            >
                ログインする
            </button>
    ...
    <div class="flex flex-col items-center gap-4 my-6">
        ...
        <a
            class="text-xs text-forest cursor-pointer hover:text-forest-dark"
            href="{{ route('password.request', ['from' => 'thinkmotion']) }}"
            >パスワードをお忘れの方はこちら</a
        >
    </div>
@endsection
